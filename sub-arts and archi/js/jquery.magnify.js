    ...
    creatDOM: function () {
        ...
        var magnifyHTML = '<div class="magnify-modal">\
                                <div class="magnify-header">\
                                    <div class="magnify-toolbar">' + this.creatBtns(btnsTpl) + ' ' + btnsTpl.maximize + btnsTpl.close + '</div>\
                                </div>\
                                <div class="magnify-stage">\
                                    <img src="" alt="" title="">\
                                </div>\
                                <div class="magnify-footer">\<div class="magnify-title"></div>\
                                    <div class="magnify-toolbar"></div>\
                                </div>\
                            </div>';
